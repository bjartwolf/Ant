...
godown                  lda antPosByteLSB
                        and #$07
                        beq godowntonextchar ; branch if three last bits is zero      
                        dec antPosByteLSB   ; ca not overflow because it is nnot zer        
                        jmp loop
godowntonextchar        sec                 ; result is zero, set carry to borrow        
...
goup                    lda antPosByteLSB
                        ...
                        beq gouptonextchar  ; if 7&y != 7 then take loop        
                        inc antPosByteLSB   ; move up one, can not overflow as not 7       
                        jmp loop
gouptonextchar          clc 
